        ...
        <div className="container">
          <div className="columns cols-md col-center">
            ...
            <div className="column col-sm-12 col-6">
              ...
              <p>The event is free and food will be provided. Prizes for winners. Recommended team size is 2 - 4, we'll pair you up other students attending the event if you can't find a team.</p>
            </div>
          </div>
        </div>
      </section>
